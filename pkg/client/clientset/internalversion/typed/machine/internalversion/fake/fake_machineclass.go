...
func (c *FakeMachineClasses) Get(name string, options v1.GetOptions) (result *machine.MachineClass, err error) {
	obj, err := c.Fake.
...
func (c *FakeMachineClasses) List(opts v1.ListOptions) (result *machine.MachineClassList, err error) {
	obj, err := c.Fake.
...
func (c *FakeMachineClasses) Create(machineClass *machine.MachineClass) (result *machine.MachineClass, err error) {
	obj, err := c.Fake.
...
func (c *FakeMachineClasses) Update(machineClass *machine.MachineClass) (result *machine.MachineClass, err error) {
	obj, err := c.Fake.
...
func (c *FakeMachineClasses) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *machine.MachineClass, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(machineclassesResource, c.ns, name, data, subresources...), &machine.MachineClass{})
