...
func (c *controller) kubeVirtMachineClassToSecretAdd(obj interface{}) {
	machineClass, ok := obj.(*v1alpha1.KubeVirtMachineClass)
	if machineClass == nil || !ok {
		return
	}
	c.secretQueue.Add(machineClass.Spec.SecretRef.Namespace + "/" + machineClass.Spec.SecretRef.Name)
...
func (c *controller) kubeVirtMachineClassToSecretUpdate(oldObj interface{}, newObj interface{}) {
	oldMachineClass, ok := oldObj.(*v1alpha1.KubeVirtMachineClass)
	if oldMachineClass == nil || !ok {
		return
	}
	newMachineClass, ok := newObj.(*v1alpha1.KubeVirtMachineClass)
	if newMachineClass == nil || !ok {
		return
	}
...
func (c *controller) kubeVirtMachineClassToSecretDelete(obj interface{}) {
	c.kubeVirtMachineClassToSecretAdd(obj)
}
